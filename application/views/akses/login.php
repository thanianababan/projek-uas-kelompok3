...
<head>
	<title>Login - CleanYourArea</title>
	<meta charset="UTF-8">
...
<body class="login-page">
	<div class="login-box">
		<div class="logo">
			<center><img src="<?= base_url('assets/images/logoweb.png') ?>" type="image/x-icon" alt="LogoWeb"></center>
		...
		<div class="card">
			<div class="body">
				...
				<div class="msg">Silahkan untuk login dahulu</div>
