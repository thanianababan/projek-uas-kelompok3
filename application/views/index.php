	...
	<nav class="navbar">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?= site_url('beranda/p/beranda') ?>" style="text-transform: none;">Aplikasi Jasa Kebersihan Clean Your Area</a>
			</div>
		</div>
	</nav>
	<!-- #Top Bar -->
			...
			<div class="menu">
				<ul class="list">
					...
					<li <?= $master; ?>>
						...
						<ul class="ml-menu">
							<li><a href="<?= site_url('users/p/data')  ?>">Users</a></li>
							<li><a href="<?= site_url('pelanggan/p/data')  ?>">Pelanggan</a></li>
